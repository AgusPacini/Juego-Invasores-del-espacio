...
public class PanelFG extends JPanel implements KeyListener{ 
    ...
    ImageIcon background =new ImageIcon ("images/BackgroundSkin.jpg");
    NaveGrafico nave;
    ...
    { 
        ...
        {          
           ...
           int i;
            ...
            TextoGrafico PaciniyOlguin = new TextoGrafico("Pacini y Olguin",Color.BLACK,1750,1100);
            PaciniyOlguin.setSize(20);
            v.add(TextoNrNivel);
            v.add(TextoNivel);
            v.add(PaciniyOlguin);
